...
public final class Messages {
    ...
    public static final String PLUGIN_SUCCESSFUL_FINISH = "Leaptest for Teamcity  plugin  successfully finished!";
    public static final String PLUGIN_ERROR_FINISH = "Leaptest for Teamcity plugin finished with errors!";
